...
export interface GraphQLExecutionContext {
  ...
  errors: Array<typeof GraphQLError>;
}
...
export type IScalarTypeResolver = typeof GraphQLScalarType & {
  __name?: string;
...
export type ScalarTypeVisitor = (
  type: typeof GraphQLScalarType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLScalarType | null | undefined;

export type EnumTypeVisitor = (
  type: typeof GraphQLEnumType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLEnumType | null | undefined;
...
export type ObjectTypeVisitor = (
  type: typeof GraphQLObjectType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLObjectType | null | undefined;

export type InputObjectTypeVisitor = (
  type: typeof GraphQLInputObjectType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLInputObjectType | null | undefined;

export type AbstractTypeVisitor = (
  type: typeof GraphQLInterfaceType | typeof GraphQLUnionType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLInterfaceType | typeof GraphQLUnionType | null | undefined;

export type UnionTypeVisitor = (
  type: typeof GraphQLUnionType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLUnionType | null | undefined;

export type InterfaceTypeVisitor = (
  type: typeof GraphQLInterfaceType,
  schema: typeof GraphQLSchema,
) => typeof GraphQLInterfaceType | null | undefined;
...
export type DirectiveMapper = (
  ...
  schema: typeof GraphQLSchema,
) => typeof GraphQLDirective | null | undefined;

export type GenericFieldMapper<
